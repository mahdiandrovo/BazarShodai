...
public abstract class NoteDatabase extends RoomDatabase {
    ...
    private static class PopulateDatabaseAsyncTask extends AsyncTask<Void,Void,Void>{
        ...
        protected Void doInBackground(Void... voids) {
            noteDao.insert(new Note("Title 1","Description 1",1,"Amounnt", 1));
            noteDao.insert(new Note("Title 2","Description 2",2,"Amounnt", 2));
            noteDao.insert(new Note("Title 3","Description 3",3,"Amounnt", 3));
            return null;
        }
    }
